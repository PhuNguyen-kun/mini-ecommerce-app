...
module.exports = (sequelize) => {
    class Order extends Model {
        static associate(models) {
            ...
            Order.hasMany(models.PaymentTransaction, { foreignKey: "order_id", as: "transactions" });
    ...
    Order.init({
        ...
        status: {
            type: DataTypes.ENUM('PENDING_PAYMENT', 'PAID', 'SHIPPING', 'COMPLETED', 'CANCELLED', 'PAYMENT_FAILED'),
        ...
        // Payment
        payment_method: { type: DataTypes.ENUM('VNPAY_FAKE', 'COD', 'TEST'), defaultValue: 'VNPAY_FAKE' },
