...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert("product_images", [
      // Áo len nữ
      { product_id: 1, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=800", is_primary: true },
      { product_id: 1, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=800", is_primary: false },

      { product_id: 2, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=800", is_primary: true },
      { product_id: 2, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=800", is_primary: false },

      { product_id: 3, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=800", is_primary: true },
      { product_id: 3, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1485968579580-b6d095142e6e?w=800", is_primary: false },

      // Quần nữ
      { product_id: 4, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=800", is_primary: true },
      { product_id: 4, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1584370848010-d7fe6bc767ec?w=800", is_primary: false },

      { product_id: 5, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1594633313593-bab3825d0caf?w=800", is_primary: true },
      { product_id: 5, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=800", is_primary: false },

      { product_id: 6, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=800", is_primary: true },
      { product_id: 6, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1520367691844-86a5d8777ac4?w=800", is_primary: false },

      // Boots nữ
      { product_id: 7, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=800", is_primary: true },
      { product_id: 7, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1608256246200-53e635b5b65f?w=800", is_primary: false },

      { product_id: 8, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1605812860427-4024433a70fd?w=800", is_primary: true },
      { product_id: 8, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1603487742131-4160ec999306?w=800", is_primary: false },

      // Váy/Đầm
      { product_id: 9, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=800", is_primary: true },
      { product_id: 9, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=800", is_primary: false },

      { product_id: 10, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=800", is_primary: true },
      { product_id: 10, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=800", is_primary: false },

      // Giày cao gót & bệt
      { product_id: 11, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=800", is_primary: true },
      { product_id: 11, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1535043934128-cf0b28d52f95?w=800", is_primary: false },

      { product_id: 12, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1603808033192-082d6919d3e1?w=800", is_primary: true },
      { product_id: 12, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1560343090-f0409e92791a?w=800", is_primary: false },

      // Áo khoác nữ
      { product_id: 13, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=800", is_primary: true },
      { product_id: 13, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1558769132-cb1aea3c862a?w=800", is_primary: false },

      { product_id: 14, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800", is_primary: true },
      { product_id: 14, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1539533018447-63fcce2678e3?w=800", is_primary: false },

      // Túi xách
      { product_id: 15, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=800", is_primary: true },
      { product_id: 15, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=800", is_primary: false },

      // Áo thun nữ
      { product_id: 16, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800", is_primary: true },
      { product_id: 16, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=800", is_primary: false },

      // Áo kiểu
      { product_id: 17, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=800", is_primary: true },
      { product_id: 17, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=800", is_primary: false },

      // Men's products
      { product_id: 18, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=800", is_primary: true },
      { product_id: 19, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=800", is_primary: true },
      { product_id: 20, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=800", is_primary: true },
      { product_id: 21, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1485968579580-b6d095142e6e?w=800", is_primary: true },
      { product_id: 22, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=800", is_primary: true },
      { product_id: 23, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=800", is_primary: true },
      { product_id: 24, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800", is_primary: true },
      { product_id: 25, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1542840410-3092f99611a3?w=800", is_primary: true },
      { product_id: 26, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1608256246200-53e635b5b65f?w=800", is_primary: true },
      { product_id: 27, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=800", is_primary: true },
      { product_id: 28, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800", is_primary: true },
      { product_id: 29, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800", is_primary: true },
      { product_id: 30, product_option_value_id: null, image_url: "https://images.unsplash.com/photo-1622445275463-afa2ab738c34?w=800", is_primary: true },
    ]);
