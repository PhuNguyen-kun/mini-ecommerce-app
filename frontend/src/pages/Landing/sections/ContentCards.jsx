  ...
  return (
    <section className="w-full px-[185px] py-[90px] flex gap-5">
      ...
      <div className="w-[505px]">
        <h2 className="text-[34px] font-normal mb-[54px] text-center">Our Holiday Gift Picks</h2>
        ...
        <p className="text-[17px] mb-9 text-center">
      ...
      {/* Cleaner Fashion */}
      <div className="w-[505px]">
        <h2 className="text-[34px] font-normal mb-[54px] text-center">Cleaner Fashion</h2>
        <div className="w-full h-[626px] rounded-lg overflow-hidden mb-5">
          <img 
            src={giftImg} 
            alt="Cleaner Fashion" 
