                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      <div className="flex gap-3 items-start">
                        <div className="flex-1">
                          ...
                          <p
                            className="text-xs text-[#737373] mt-0.5 leading-4 tracking-[0.2px]"
                            style={{ fontFamily: "Maison Neue, sans-serif" }}
                          >
                      ...
                      <div className="flex items-end justify-between">
                        <div className="flex flex-col leading-4 tracking-[0.2px]">
                          <div className="flex items-center gap-0.5">
                            <span
                              className="text-xs text-[#262626] font-[600]"
                              style={{ fontFamily: "Maison Neue, sans-serif" }}
                            >
                              {formatPrice(
                                item.unit_price ||
                        ...
                        <div className="flex items-center border border-[#DDDBDC]">
                          <button
                            ...
                            className="px-[15px] py-3 hover:bg-[#F5F5F5] transition-colors relative z-10"
                          >
                            <TbMinus size={12} />
                          </button>
                          <span
                            className="py-3 text-xs font-[400] text-center min-w-[15px] leading-4 tracking-[0.2px] relative z-10"
                            style={{ fontFamily: "Maison Neue, sans-serif" }}
                          >
                            {item.quantity}
                          </span>
